...
// types
import { GetTransferCpResponse } from '~/types/api-filesystem'
// helpers
...
// apis
import { postLocalTransferCp } from '~/apis/filesystem-api'
// browsers
...
const CopyForm: React.FC<any> = ({ formData, onSuccess, onError }) => {
  ...
  const handleOnSubmit = (event: any) => {
    ...
    const fetchData = async () => {
      const response: GetTransferCpResponse = await postLocalTransferCp(
        formData.system,
        sourcePath,
  ...
  return (
    <form className='relative' onSubmit={handleOnSubmit}>
      ...
      <AlertInfo title='Asynchronous Copy Notice' className='mb-4'>
        <p className='mb-2'>
